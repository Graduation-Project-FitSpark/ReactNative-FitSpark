...
import Homepage from "./Coachomepage.jsx";
import Traineetable from "../CachActivities/Traineetable.jsx";
import AnalyticsSection from "../CachActivities/AnalyticsSection.jsx";
...
export default function Coachmanbur() {
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({

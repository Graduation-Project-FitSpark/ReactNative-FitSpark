...
function ChatTrainerSpecialist({ route, navigation }) {
  ...
  const { messages } = useMessages(trainerId, specialistId);
  ...
  const handleSendMessage = () => {
    ...
    if (specialistId) {
      sendMessage(input, trainerId, specialistId);
      setInput("");
    }
  };
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => {
            const isLastMessage =
              ...
              combinedMessages[index + 1]?.senderId !== item.senderId;

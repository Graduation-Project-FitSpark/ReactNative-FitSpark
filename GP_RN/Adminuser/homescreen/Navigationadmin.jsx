    ...
    <View style={styles.container}>
      ...
      <View style={styles.menuContainer}>
        ...
        >
          ...
          <Text style={styles.menuItem}>Add Awards</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.menuItemContainer}
          onPress={() => navigation.navigate("Requestcoachspecialist")}
        >
          <IconIonicons name="clipboard" size={24} color="#000" />
          <Text style={styles.menuItem}>Applicants</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.menuItemContainer}
